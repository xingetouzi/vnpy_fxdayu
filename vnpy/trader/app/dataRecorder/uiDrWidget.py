...
class DrEngineManager(QtWidgets.QWidget):
    ...
    def initUi(self):
        ...
        grid.addWidget(barLabel, 2, 0)
        grid.addWidget(activeLabel, 4, 0)
        grid.addWidget(self.tickTable, 1, 0)
        grid.addWidget(self.barTable, 3, 0)
        grid.addWidget(self.activeTable, 5, 0)  
             
        hbox = QtWidgets.QHBoxLayout()
        hbox.addLayout(grid,1)
        hbox.addWidget(self.logMonitor,3)
        self.setLayout(hbox)
